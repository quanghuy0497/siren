...
# ./configs/bdd/siren.sh bdd_id --resume checkpoint/checkpoint_bdd_siren.pth --eval --viz_prediction_results
# ./configs/bdd/siren.sh coco_ood --resume checkpoint/checkpoint_bdd_siren.pth --eval --viz_prediction_results
# ./configs/bdd/siren.sh openimages_ood --resume checkpoint/checkpoint_bdd_siren.pth --eval --viz_prediction_results